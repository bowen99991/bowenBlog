import { _ as _export_sfc, r as resolveComponent, o as openBlock, c as createElementBlock, b as createBaseVNode, d as createTextVNode, e as createVNode, a as createStaticVNode } from "./app-c95e58ad.js";
...
const _hoisted_260 = /* @__PURE__ */ createBaseVNode(
  ...
  null,
  [
    /* @__PURE__ */ createBaseVNode("strong", null, "HTTP状态码列表:")
  ],
  -1
  /* HOISTED */
);
...
const _hoisted_311 = /* @__PURE__ */ createStaticVNode('<h3 id="_22-同源策略" tabindex="-1"><a class="header-anchor" href="#_22-同源策略" aria-hidden="true">#</a> 22，同源策略</h3><p><strong>同源策略：Same Origin Policy SOP 是浏览器的策略</strong></p><ul><li>同源策略(Same-Origin Policy)最早由 Netscape 公司提出，是浏览器的一种安全策略</li><li>规定：只允许两个页面有相同的源时，一个页面才可以去访问另一个页面中的数据。</li><li>源：说白了，就是指域名 相同的源指的是有相同的域名</li><li>换句话说，jd.com不能去获取taobao.com下面的数据</li></ul><p>有一个这样的域名：http://www.wangcai.com</p><ul><li>http://zhidao.wangcai.com 不同源</li><li>http://www.wangcai.com:8080 不同源</li><li>https://www.wangcai.com 不同源</li><li>http://www.wangcai.com/phone/index.html 同源</li><li>http://www.wangcai.com/phone/huawei/index.html 同源</li></ul><p><strong>总结</strong></p><ul><li>源：协议 + 域名 + 端口</li><li><strong>同源：相同的协议 &amp;&amp; 相同域名 &amp;&amp; 相同的端口</strong></li><li>不同源：不同的协议 || 不同的域名 || 不同的端口</li></ul><p><strong>不受同源策略的限制</strong></p><ul><li>资源的引入 如：img标签的src link标签的href script标签的src</li><li>页面中的超连接 a标签中的href</li><li>表单的提交</li><li>重定向页面</li></ul><h3 id="_23-postman的使用" tabindex="-1"><a class="header-anchor" href="#_23-postman的使用" aria-hidden="true">#</a> 23，postman的使用</h3><p><em>也可以使用轻量级插件( Postcode ) ,在一定的功能上实现是一致的</em></p><h3 id="_24-开源接口" tabindex="-1"><a class="header-anchor" href="#_24-开源接口" aria-hidden="true">#</a> 24，开源接口</h3><p>开源接口：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>https://docs.tenapi.cn/\nhttps://www.free-api.com/\nhttps://api.aa1.cn/\n</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如图所示(使用Postman请求参数):</p><p><img src="' + _imports_11 + '" alt="image-20231008182133488"></p><p>请求方式: GET</p><p>请求URL : xxxxxxxxxxx</p><p>请求参数类型 : ?type = json</p><p><img src="' + _imports_12 + '" alt="image-20231008182715153"></p>', 20);
