...
const _hoisted_7 = /* @__PURE__ */ createStaticVNode('<h2 id="需求分析" tabindex="-1"><a class="header-anchor" href="#需求分析" aria-hidden="true">#</a> 需求分析</h2><ol><li>用户添加标签 , 标签分类</li><li>主动搜索</li><li>组队 <ol><li>创建队伍</li><li>加入</li><li>查询队伍</li><li>邀请其他人</li></ol></li><li>允许用户去修改标签</li><li>推荐 <ol><li>相似度计算算法 + 本地分布式计算</li></ol></li></ol><h2 id="技术栈" tabindex="-1"><a class="header-anchor" href="#技术栈" aria-hidden="true">#</a> 技术栈</h2><h3 id="前端" tabindex="-1"><a class="header-anchor" href="#前端" aria-hidden="true">#</a> 前端</h3><ol><li>Vue3 开发框架(提高页面开发的效率)</li><li>VanUI (基于Vue 的移动端组件库)</li><li>Vite (打包工具 轻便快捷)</li><li>Nginx 单机部署</li></ol><h3 id="后端" tabindex="-1"><a class="header-anchor" href="#后端" aria-hidden="true">#</a> 后端</h3><ol><li>Java + springBoot 框架</li><li>SpringMVC + MyBatis + MyBatisPlus</li><li>MySQL</li><li>Redis 缓存</li></ol><h2 id="计划" tabindex="-1"><a class="header-anchor" href="#计划" aria-hidden="true">#</a> 计划</h2><ol><li>前端项目初始化</li><li>前段主页 + 组件概览</li></ol><h2 id="前端项目初始化" tabindex="-1"><a class="header-anchor" href="#前端项目初始化" aria-hidden="true">#</a> 前端项目初始化</h2><p>用脚手架初始化项目</p><p>Vue Cli 脚手架</p><p>vite 构建工具</p>', 13);
const _hoisted_20 = {
